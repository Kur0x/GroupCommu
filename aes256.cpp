...
ByteArray::size_type
Aes256::encrypt(const ByteArray &key, const unsigned char *plain, const ByteArray::size_type plain_length,
                ByteArray &encrypted) {
    Aes256 aes(key);
...
ByteArray::size_type
Aes256::decrypt(const ByteArray &key, const unsigned char *encrypted, const ByteArray::size_type encrypted_length,
                ByteArray &plain) {
    Aes256 aes(key);
...
ByteArray::size_type
Aes256::encrypt_continue(const unsigned char *plain, const ByteArray::size_type plain_length, ByteArray &encrypted) {
...
ByteArray::size_type
Aes256::decrypt_continue(const unsigned char *encrypted, const ByteArray::size_type encrypted_length,
                         ByteArray &plain) {
    ByteArray::size_type i = 0;
