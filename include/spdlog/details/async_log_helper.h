...
namespace spdlog {
    namespace details {
            ...
            struct async_msg {
                ...
                explicit async_msg(const details::log_msg &m)
                        : level(m.level), time(m.time), thread_id(m.thread_id), txt(m.raw.data(), m.raw.size()),
                          msg_type(async_msg_type::log), msg_id(m.msg_id) {
        ...
        public:
            ...
            async_log_helper(formatter_ptr formatter, std::vector<sink_ptr> sinks, size_t queue_size,
...
///////////////////////////////////////////////////////////////////////////////
inline spdlog::details::async_log_helper::async_log_helper(formatter_ptr formatter, std::vector<sink_ptr> sinks,
                                                           size_t queue_size,
        ...
        : _formatter(std::move(formatter)), _sinks(std::move(sinks)), _q(queue_size),
          _err_handler(std::move(err_handler)), _flush_requested(false), _terminate_requested(false),
